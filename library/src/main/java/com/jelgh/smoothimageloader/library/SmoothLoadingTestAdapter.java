...
public abstract class SmoothLoadingTestAdapter extends WrapperListAdapterImpl implements SmoothLoadingAdapter {

	private SmoothImageLoader mImageLoader;
	private ScrollListener mScrollListener;
	private int mDefaultImgResource = -1;

	public SmoothLoadingTestAdapter(ListAdapter adapter, ScrollListener scrollListener, IBitmapStorageApi api) {
		super(adapter);
